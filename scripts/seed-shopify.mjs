...
const BRANDS = [
  ...
  // Pharmacy / European brands
  { name: "Avene",              domain: "aveneusa.com" },
  { name: "La Roche-Posay",     domain: "laroche-posay.us" },
  { name: "Bioderma",           domain: "biodermausa.com" },
  { name: "Vichy",              domain: "vichyusa.com" },
  { name: "Eucerin",            domain: "eucerinus.com" },
  ...
  { name: "Vanicream",          domain: "vanicream.com" },
  { name: "Paula's Choice",     domain: "paulaschoice.com" },
  { name: "Drunk Elephant",     domain: "drunkelephant.com" },
  { name: "Kiehl's",            domain: "kiehls.com" },
  { name: "Skinceuticals",      domain: "skinceuticals.com" },
  { name: "iS Clinical",        domain: "isclinical.com" },
  { name: "EltaMD",             domain: "eltamd.com" },
  { name: "Supergoop",          domain: "supergoop.com" },
  { name: "Obagi",              domain: "obagi.com" },
  { name: "Dr. Jart+",          domain: "drjart.com" },
