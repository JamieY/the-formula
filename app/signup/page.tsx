      ...
      <div className="flex flex-1 items-center justify-center px-6 py-16">
        <div className="w-full max-w-md">
          ...
          <p className="text-stone-500 text-center mb-8">
            Start building your personal product formula.
          </p>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-stone-100">
            <form className="flex flex-col gap-5">
              ...
              <button
                type="submit"
                className="w-full py-3 rounded-full text-white font-medium text-sm mt-2"
            ...
            <button className="w-full py-3 rounded-full border border-stone-200 text-stone-700 font-medium text-sm flex items-center justify-center gap-3 hover:bg-stone-50">
